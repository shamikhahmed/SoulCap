...
## Current state (v5.0.7 — 2026-07-24)
...
### Schema & ship
- State `DEFAULT.v = 12` · SW `soulcap-v507` · app **5.0.7**
- **v4.0 + v5.0 complete** (master design + native motion).
