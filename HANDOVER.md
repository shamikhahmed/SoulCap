...
## Current state (v6.0.1 — 2026-07-27)
...
naming in UI keys. Fixed tab footer + readable secondary text; compact tiles; soft selection;
FAB off (header Help).
...
### Schema & ship
- State `DEFAULT.v = 12` · SW `soulcap-v601` · app **6.0.1** · `package.json` **6.0.1**
