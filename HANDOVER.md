...
## Current state (v5.0.6 — 2026-07-24)
...
### Schema & ship
- State `DEFAULT.v = 12` · SW `soulcap-v506` · app **5.0.6**
- **v4.0 complete.** v5 PR-1–7 shipped. Next: PR-8 perf/a11y.
