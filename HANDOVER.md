...
## Current state (v5.0.0 — 2026-07-24)
...
### Schema & ship
- State `DEFAULT.v = 12` · SW `soulcap-v500` · app **5.0.0**
- **v4.0 master design complete.** Building `SPEC-v5.0-native-motion.md` (PR-1 shipped).
