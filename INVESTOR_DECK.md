...
> **Product honesty (read first):** The live product (**v7.0.11** / schema v13) is an offline
...
> demo as AI, therapy, clinical care, or a crisis service. See `README.md`, `REDESIGN-DIFF.md`,
> and `SAFETY.md`.
