...
**Current release: v8.0.1** · schema v13 · **SPEC-v8 IA** shipped (`IA-RATIONALE.md`) · Quiet Depth (SPEC-v7) **shipped** · SPEC-v6.0 A→J **shipped** ·
...
- Auto / Light / Dark / Night / AMOLED + Ocean / Forest (Rain/Space/Sunrise/Minimal deleted in v6).
